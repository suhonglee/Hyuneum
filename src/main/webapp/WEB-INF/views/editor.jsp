...
<%@ taglib prefix="c" uri="http://java.sun.com/jstl/core" %>
  <head>
    ...
    -->
    <link rel="stylesheet" href="${CONTEXT}/resources/daumeditor/css/editor.css" type="text/css" charset="utf-8"/>
    <script src="https://code.jquery.com/jquery-1.10.2.min.js"></script>
    <script src="${CONTEXT}/resources/daumeditor/js/editor_loader.js" type="text/javascript" charset="utf-8"></script>
...
<div class="body">
	...
	-->
	<form name="tx_editor_form" id="tx_editor_form" action="http://posttestserver.com/post.php" method="post" accept-charset="utf-8" enctype="multipart/form-data">
		<input type="hidden" name="code" value="${code }"/>
		<div id="input-subject-box">
			제목 : <input type="text" name="title" id="title" size="90">
		</div>
		<br/>
						...
						<div id="tx_richtextbox_menu" class="tx-richtextbox-menu tx-menu">
							...
							<div class="tx-menu-footer">
								<img class="tx-menu-confirm"
									 src="${CONTEXT}/resources/daumeditor/images/icon/editor/btn_confirm.gif?rv=1.0.1" alt=""/>
								<img class="tx-menu-cancel" hspace="3"
									 src="${CONTEXT}/resources/daumeditor/images/icon/editor/btn_cancel.gif?rv=1.0.1" alt=""/>
							</div>
						</div>
					</li>
					<li class="tx-list">
		...
		<div id="tx_canvas" class="tx-canvas">
			<div id="tx_loading" class="tx-loading"><div><img src="${CONTEXT}/resources/daumeditor/images/icon/editor/loading2.png" width="113" height="21" align="absmiddle"/></div></div>
		...
		<div id="tx_resizer" class="tx-resize-bar">
			...
			<img id="tx_resize_holder" src="${CONTEXT}/resources/daumeditor/images/icon/editor/skin/01/btn_drag01.gif" width="58" height="12" unselectable="on" alt="" />
		</div>
						<div class="tx-side-bi" id="tx_side_bi">
			<div style="text-align: right;">
				<img hspace="4" height="14" width="78" align="absmiddle" src="${CONTEXT}/resources/daumeditor/images/icon/editor/editor_bi.png" />
			</div>
		</div>
		<!-- 편집영역 끝 -->
		<!-- 첨부박스 시작 -->
			<!-- 파일첨부박스 Start -->
			<!-- 전체화면 시 파일첨부 목록이 보이지 않도록 display 막아줌 -->
		<div style="display:none;">
			<div id="tx_attach_div" class="tx-attach-div">
				<div id="tx_attach_txt" class="tx-attach-txt">파일 첨부</div>
				<div id="tx_attach_box" class="tx-attach-box">
					<div class="tx-attach-box-inner">
						<div id="tx_attach_preview" class="tx-attach-preview"><p></p><img src="${CONTEXT}/resources/daumeditor/images/icon/editor/pn_preview.gif" width="147" height="108" unselectable="on"/></div>
...
<script type="text/javascript">
	var config = {
		...
		txIconPath: "${CONTEXT}/resources/daumeditor/images/icon/editor/", /*에디터에 사용되는 이미지 디렉터리, 필요에 따라 수정한다. */
		txDecoPath: "${CONTEXT}/resources/daumeditor/images/deco/contents/", /*본문에 사용되는 이미지 디렉터리, 서비스에서 사용할 때는 완성된 컨텐츠로 배포되기 위해 절대경로로 수정한다. */
		canvas: {
			styles: {
				color: "#123456", /* 기본 글자색 */
...
<script type="text/javascript">
	function saveContent(url) {
		$("#tx_editor_form").attr("action",url);
...
<div><button onclick='saveContent()' style="display: none">SAMPLE - submit contents</button></div>
<!-- End: Saving Contents -->
...
<div><button onclick='loadContent()' style="display: none">SAMPLE - load contents to editor</button></div>
